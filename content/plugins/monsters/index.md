...
{{< article link="/plugins/monster_list/" >}}
...
### 装備
一部の人型モンスターには装備を持たせることができます。
管理画面右下のアイコンから装備画面を開くことができ、メインハンド/オフハンド/ヘルメット/チェストプレート/レギンス/ブーツ をそれぞれ設定することができます。
![](equipment.png)
